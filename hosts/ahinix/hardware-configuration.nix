...
# to /etc/nixos/configuration.nix instead.
{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/bdc126b1-9549-46d9-89f8-7c285ce90a31";
    fsType = "ext4";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/3ACD-7407";
    fsType = "vfat";
  };

  swapDevices = [
    {device = "/dev/disk/by-uuid/ec5afbb1-94d6-4977-9ce3-6504a460388d";}
  ];
